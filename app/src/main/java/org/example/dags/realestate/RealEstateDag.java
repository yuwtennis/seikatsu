...
public class RealEstateDag implements Dag {
  ...
  public void process(final Pipeline p) {
    ...
    GcpOptions gcpOptions = p.getOptions().as(GcpOptions.class);
    ...
    responses
        ...
        .apply(
            ...
            BigQueryIO.<RealEstatesPrice>write()
                .useBeamSchema()
                .to(gcpOptions.getProject() + ":" + BQ_DATASET + "." + BQ_RSP_TABLE)
    ...
    responses
        ...
        .apply(
            ...
            BigQueryIO.<StandardLandPrice>write()
                .useBeamSchema()
                .to(gcpOptions.getProject() + ":" + BQ_DATASET + "." + BQ_SLP_TABLE)
                .withCreateDisposition(BigQueryIO.Write.CreateDisposition.CREATE_IF_NEEDED)
                .withWriteDisposition(BigQueryIO.Write.WriteDisposition.WRITE_TRUNCATE));
