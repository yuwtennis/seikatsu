...
public final class Utils {
  ...
  public static int asInt(final String val) {
    ...
    try {
      ...
      result = Integer.parseInt(Magics.IS_UNEXPECTED_NUMERIC_VAL.getValue());
    }
  ...
  public static float asFloat(final String val) {
    ...
    try {
      ...
      result = Float.parseFloat(Magics.IS_UNEXPECTED_NUMERIC_VAL.getValue());
    }
  ...
  public static String from4digitStr(final String val) {
    return String.format(
        "%s-%s-%s",
        val.substring(asInt(Magics.NUM_0.getValue()), asInt(Magics.NUM_4.getValue())),
        val.substring(asInt(Magics.NUM_4.getValue()), asInt(Magics.NUM_6.getValue())),
        val.substring(asInt(Magics.NUM_6.getValue()), asInt(Magics.NUM_8.getValue())));
  }
}
